...
| **Groundwater Link**| Disconnected from soil/rock properties | Multi-layered aquifer yield modeling ($Sy$) for water table projection |
...
* **The Science**:
  * Instead of measuring rainfall deficits alone, CoRE Stack builds a composite index mapping:
    ...
    * **Agricultural Drought**: Vegetation Condition Index (VCI) from MODIS NDVI and Moisture Adequacy Index (MAI) from ET/PET.
...
* **The Science**:
  * Intersects geological rock permeability (**Lithology**), structural fractures (**Lineaments**), stream density (**Drainage Density**), and terrain gradients (**Slope %**) to calculate Recharge Potential.
